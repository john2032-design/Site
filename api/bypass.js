...
module.exports = async (req, res) => {
  ...
  const voltarOnlyExclusive = ['work.ink','pandadevelopment.net','keyrblx.com','airflowscript.com','blox-script.com','neoxsoftworks.eu','cuty.io','cety.io','linkvertise.com'];
  const abysmOnlyExclusive = ['loot-link.com','lootlink.org','lootlinks.co','lootdest.info','lootdest.org','lootdest.com','links-loot.com','loot-links.com','linkvertise.com','lootlinks.com','loot-labs.com','lootlabs.com','mboost.me','cuty.io','cutynow.com','cutty.com','cuttlinks.com','cuttty.com'];
  ...
  if (hostname === 'linkvertise.com' || hostname.endsWith('.linkvertise.com')) {
    const voltarResult = await tryVoltar();
    if (voltarResult.success) return;
    const abysmResult = await tryAbysm();
    if (abysmResult.success) return;
