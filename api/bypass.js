...
const SITE_SECRET = '9f3c1e2a7d4b8c6f5a0e91d7b2c4f6e8a1d3b5c7e9f0a2b4d6c8e1f3a5b7';
module.exports = async (req, res) => {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type,x-user-id,x-site-token,Origin,Referer');
